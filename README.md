...
|`open_link`|`--open/--no-open`| -      |Открыть в браузере после создания |
...
- [ ] Идеи
    ...
    - [ ] Псевдонимы для customfield на уровне кода. В конфиг - слишком сложно, 
        ...
        - [ ] sprint
            ...
            - [ ] В шаблоне, как $sprint / jtl_sprint / jtl.sprint / {jtl.sprint} / {{jtl.sprint}} (для Jinja)
            - [ ] Опция командной строки --sprint
                - [ ] Автодополнение
                - [ ] Алиас --sprint active (или current)
        - [ ] component
        - [ ] team
